<template>
  <div class="window-title" v-if="!IsUseSysTitle && isNotMac && !IsWeb">
    ...
    <div style="-webkit-app-region: drag" class="logo">
      <img src="@web/assets/icons/svg/electron-logo.svg" class="icon-logo" />
    </div>
    <!-- 菜单栏位置 -->
    <div></div>
    <!-- 中间标题位置 -->
    ...
    <div class="controls-container">
      <div class="windows-icon-bg" @click="Mini">
        <img src="@web/assets/icons/svg/mini.svg" class="icon-size" />
      </div>
      <div class="windows-icon-bg" @click="MixOrReduction">
        <img v-if="mix" src="@web/assets/icons/svg/reduction.svg" class="icon-size" />
        <img v-else src="@web/assets/icons/svg/mix.svg" class="icon-size" />
      </div>
      <div class="windows-icon-bg close-icon" @click="Close">
        <img src="@web/assets/icons/svg/close.svg" class="icon-size" />
      </div>
    </div>
  </div>
